...
TRAP_DAMAGE_THRESHOLD = 3 # порог урона от ловушки (30% шанс)

TRAP_DAMAGE_RANGE = 10 # диапазон броска урона (0-9)

EVENT_PROBABILITY = 10 # вероятность случайного события (10%)

TRAP_PROBABILITY = 10 # вероятность срабатывания ловушки (10%)